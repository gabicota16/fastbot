...
const smsLista1 = () => { return `🌟 INFORMAÇÕES DO FASTBOT 🌟`}
...
const smsLista7 = () => { return `🐈 INSTALAR O FastBOT 🐈`}
...
//_allantilink.js
const smsTextoYT = () => { return '😻 Super FastBot-MD - WhatsApp '}
...
const smsModP2 = () => { return `Ativar função para que todos possam usar o FastBot`}
const smsModAd1 = () => { return `🛂 MODO ADMINISTRADOR`}
const smsModAd2 = () => { return `Apenas Admins poderão usar o FastBot em Grupos`}
...
const smsJBInfo2 = () => { return `💖 *A função é estável, se apresentar algum inconveniente Entre em contato com o instagram: instagram.com:gabiacosta06*\n💝 *Você pode fazer uma doação voluntária pelo PayPal: ${global.paypal}*\n\n*Muito obrigado pelo apoio ${global.packname}*`}
...
const smsContacto4 = () => { return 'Contato Oficial FastBot 🐈'}
