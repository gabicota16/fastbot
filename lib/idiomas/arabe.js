...
const smsLista1 = () => { return `🌟 معلومات FASTBOT 🌟`}
...
const smsLista7 = () => { return `🐈 تثبيت FASTBOT 🐈`}
...
//_allantilink.js
const smsTextoYT = () => { return '😻 ممتاز FastBot-MD - WhatsApp '}
...
const smsModP2 = () => { return `تمكين الوظيفة حتى يتمكن الجميع من استخدام FastBot`}
const smsModAd1 = () => { return `🛂 وضع المشرف`}
const smsModAd2 = () => { return `سيتمكن المسؤولون فقط من استخدام FastBot في المجموعات`}
...
const smsJBInfo2 = () => { return `💖 *ا مستقرة ، إذا واجهت أي إزعاج ، فاتصل بالبريدinstagram: instagram.com/gabiacosta06*\n💝 *يمكنك تقديم تبرع طوعي عن طريق PayPal: ${global.paypal}*\n\n*شكرا جزيلا على الدعم ${global.packname}*`}
...
const smsContacto4 = () => { return 'جهة اتصال FastBot الرسمية 🐈'}
