...
const smsLista1 = () => { return `🌟 INFORMASI FASTBOT 🌟`}
...
const smsLista7 = () => { return `🐈 PASANG FASTBOT 🐈`}
...
//_allantilink.js
const smsTextoYT = () => { return 'Super Fast-Bot - WhatsApp '}
...
const smsModP2 = () => { return `Aktifkan fungsi agar semua orang dapat menggunakan FastBot`}
const smsModAd1 = () => { return `🛂 MODE ADMIN`}
const smsModAd2 = () => { return `Hanya Admin yang dapat menggunakan FastBot di Grup`}
...
const smsJBInfo2 = () => { return `💖 *Fungsinya stabil, jika menimbulkan ketidaknyamanan Hubungi instagram: instagram.com/gabiacosta06*\n💝 *Anda dapat memberikan sumbangan sukarela melalui PayPal: ${global.paypal}*\n\n*Terima kasih banyak atas dukungan ${global.packname}*`}
...
const smsContacto4 = () => { return 'Kontak Resmi FastBot 🐈'}
