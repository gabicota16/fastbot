...
const smsLista1 = () => { return `🌟 FASTBOT INFORMATION 🌟`}
...
const smsLista7 = () => { return `🐈 INSTALL FASTBOT 🐈`}
...
const smsModP2 = () => { return `Enable function so everyone can use FastBot`}
const smsModAd1 = () => { return `🛂 ADMIN MODE`}
const smsModAd2 = () => { return `Only Admins will be able to use FastBot in Groups`}
...
const smsJBInfo2 = () => { return `💖 *The function is stable, if it presents any inconvenience Contact the Instagram: instagram.com/gabiacosta06*\n💝 *You can make a voluntary donation by PayPal: ${global.paypal}*\n\n*Thank you very much for the support ${global.packname}*`}
...
const smsContacto4 = () => { return 'FastBot Official Contact 🐈'}
