...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: lenguajeGB.smsAvisoAG().slice(0,-2), body: [wm, '😻 𝗦𝘂𝗽𝗲𝗿 ' + ft + ' 😻', '🌟 instagram.com/gabiacosta06'].getRandom(), thumbnail: fastImg.getRandom(), sourceUrl: [md, nna, yt, ig, paypal, fb].getRandom() }}}}, tg)
