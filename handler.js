 ...
 *👉 Puedes contactar al propietario del Bot si crees que se trata de un error (TENER PRUEBAS) para tratar el motivo de tú desbaneo* 
 ...
 👉 ${global.asistencia} 
 👉 instagram.com/gabiacosta06
 👉 wa.me/5493491456806`.trim(); 
 m.reply(messageText); 
 ...
 user.commandCount = 1; 
                ...
                if (plugin.rowner && plugin.owner && !(isROwner || isOwner)) { // Both Owner 
                 ...
                 if (!isPrems && plugin.money && global.db.data.users[m.sender].money < plugin.money * 1) { 
                     this.reply(m.chat, `♦️ 𝙉𝙊 𝙏𝙄𝙀𝙉𝙀 𝙁𝘼𝙎𝙏𝘾𝙊𝙄𝙉𝙎`, m) 
                     continue      
                 } 
                 ...
                 try { 
                  ...
                  if (m.money) 
                         m.reply(+m.money + ' 𝙁𝘼𝙎𝙏𝘾𝙊𝙄𝙉𝙎 ♦️ 𝙐𝙎𝘼𝘿𝙊(𝙎)') 
 ...
 const numerosPermitidos = ["2", "4", "6", "7", "8", "9"] //PUEDES EDITAR LOS USUARIOS QUE SE ELIMINARÁN SI EMPIEZA POR CUALQUIER DE ESOS NÚMEROS         
