...
┃ ${rpgg.emoticon('money')} *FastCoins: » ${money}*
...
_2.Top FastCoins_ *${usersmoney.indexOf(m.sender) + 1}* _de_ *${usersmoney.length}*
...
*│ ⛏️🐱 Minar FastCoins » ${new Date - user.lastcoins < 600000 ? '❌' : '✅'}*
...
conn.sendFile(m.chat, imgr, 'fast.jpg', caption, fkontak, m, { mentions: conn.parseMention(caption) })
...
conn.sendFile(m.chat, imgr, 'fast.jpg', str, {quoted: fkontak})
...
conn.sendFile(m.chat, imgr, 'fast.jpg', str, fkontak, m, { mentions: conn.parseMention(str) })
...
conn.sendFile(m.chat, imgr, 'fast.jpg', aineh, fkontak, m)}
