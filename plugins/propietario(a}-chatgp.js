import {randomBytes} from 'crypto'; 
 ...
 const handler = async (m, {conn, text, groupMetadata}) => { 
   ...
   if (m.text.includes(linkThisGroup)) return conn.reply(m.chat, '❌ *_No puedes spamear enlaces a otros grupos._*', m); 
   ...
   const fakegif = {key: {participant: `0@s.whatsapp.net`, ...('6289643739077-1613049930@g.us' ? {remoteJid: '6289643739077-1613049930@g.us'} : {})}, message: {'videoMessage': {'title': '𝗙𝗮𝘀𝘁-𝗕𝗼𝘁', 'h': `Hmm`, 'seconds': '99999', 'gifPlayback': 'true', 'caption': '🧿 𝚃𝚑𝚎 𝙼𝚢𝚜𝚝𝚒𝚌 - 𝙱𝚘𝚝 🔮', 'jpegThumbnail': false}}}; 
