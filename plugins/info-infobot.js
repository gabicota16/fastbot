import os from 'os' 
 ...
 let enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: 'Fast-Bot', thumbnailUrl: await(await fetch(img)).buffer(), sourceUrl: yt }}} 
 ...
 conn.sendHydrated(m.chat, info, wm, pp, 'https://github.com/gabicota16/Fast-Bot', '𝗙𝗮𝘀𝘁-𝗕𝗼𝘁, null, null, [ 
 ['𝙑𝙚𝙧 𝙂𝙧𝙪𝙥𝙤𝙨 | 𝙎𝙚𝙚 𝙂𝙧𝙤𝙪𝙥𝙨', '#grupolista'], 
 ['𝘾𝙪𝙚𝙣𝙩𝙖𝙨 𝙊𝙛𝙞𝙘𝙞𝙖𝙡𝙚𝙨 | 𝘼𝙘𝙘𝙤𝙪𝙣𝙩𝙨', '/cuentasft'], 
