/*import fetch from 'node-fetch'  
 ...
 //conn.sendHydrated(m.chat, text, wm, img5, md, '𝗙𝗮𝘀𝘁-𝗕𝗼𝘁', null, null, [ 
 //['𝙑𝙤𝙡𝙫𝙚𝙧 𝙖𝙡 𝙈𝙚𝙣𝙪́ | 𝘽𝙖𝙘𝙠 𝙩𝙤 𝙈𝙚𝙣𝙪 ☘️', '/menu'] 
 //], m,) 
 } 
 handler.help = ['infogrup'] 
 handler.tags = ['group'] 
 handler.command = /^(configuración|settings|setting|configurar|configuracion|vergrupo|gruporesumen|resumen)$/i 
 handler.group = true 
