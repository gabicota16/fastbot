let linkRegex = /chat.whatsapp.com\/([0-9A-Za-z]{20,24})/i 
 ...
 m.reply(`*𝗙𝗮𝘀𝘁-𝗕𝗼𝘁 𝙎𝙀 𝙃𝘼 𝙐𝙉𝙄𝘿𝙊 𝘼𝙇 𝙂𝙍𝙐𝙋𝙊!!✅*\n*𝙎𝙐𝘾𝘾𝙀𝙎𝙎𝙁𝙐𝙇𝙇𝙔 𝙅𝙊𝙄𝙉𝙀𝘿 ✅*`) 
 await delay(5 * 5000) 
