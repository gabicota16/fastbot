let handler = async (m, { conn, isPrems}) => { 
 ...
 let fast = Math.floor(Math.random() * 3000) 
 global.db.data.users[m.sender].exp += fast * 1   
 ...
 await conn.reply(m.chat, `*${pickRandom(global.work)}* ${fast} XP`, fkontak, pp, m) 
 /*conn.sendHydrated(m.chat, wm, `${pickRandom(global.work)} ${fast} XP`, pp, md, '饾檪饾櫈饾櫓饾檭饾櫔饾櫁', null, null, [ 
