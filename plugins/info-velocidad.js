import { cpus as _cpus, totalmem, freemem } from 'os' 
 ...
 let enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: '𝗦𝘂𝗽𝗲𝗿 𝗙𝗮𝘀𝘁-𝗕𝗼𝘁 - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 ', thumbnailUrl: await(await fetch(img)).buffer(), sourceUrl: yt }}} 
 ...
 *CPU Core(s) Uso (${cpus.length} Core CPU)* 
 ...
 ` 
 await conn.sendFile(m.chat, fastImg.getRandom(), 'fast.jpg', caption, fkontak) 
 //await conn.sendButton(m.chat, wm, caption, fast.getRandom(), [['𝗠 𝗘 𝗡 𝗨 ☘️', '/menu']], m, dos.getRandom()) 
 } catch (e) { 
